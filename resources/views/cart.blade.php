...
<!-- Mirrored from rubik-market-html.wbrk.ir/cart.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 12 Aug 2023 06:32:43 GMT -->
<head>
    <meta charset="UTF-8">
                                ...
                                <div class="container">
                                    <div class="row">
                                        <div class="col-12 py-3">
                                            <div class="pb-3" id="return-to-shop">می‌خواهید محصولات دیگری اضافه کنید؟ <a href="{{route('product')}}">بازگشت به فروشگاه</a></div>
                                            ...
                                            <div class="row product">
                                                <div class="col-12 col-md-4">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-10 col-md-8">
                                                            <a href="{{route('product')}}" target="_blank"><div class="title pt-2">گوشی موبایل سامسونگ مدل Galaxy A51 دو سیم کارت</div></a>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-6 col-md-2 pr-0">
                                                    ...
                                                    <a href="#" class="product-remove btn-remove-from-basket" data-id="{{$id}}"><div class="small pl-2"><i class="fa fa-times"></i> حذف</div></a>
                                                </div>
                                            </div>
                                            <hr>
                                            <!-- Order Product Record -->
                                            ...
                                            <div class="row product">
                                                <div class="col-12 col-md-4">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-10 col-md-8">
                                                            <a href="{{route('product')}}" target="_blank"><div class="title pt-2">لپ تاپ 15 اینچی ایسوس مدل VivoBook X543MA-DM905</div></a>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-6 col-md-2">
                            ...
                            <div class="owl-carousel products-carousel">
                                ...
                                <div class="encode4326654321vfb item">
                                    ...
                                    <div class="details p-3">
                                        ...
                                        <a href="{{route('product')}}"><h2>گوشی موبایل سامسونگ مدل Galaxy A21s دو سیم کارت ظرفیت 128 گیگابایت</h2></a>
