...
<!-- Mirrored from rubik-market-html.wbrk.ir/products-list.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 12 Aug 2023 06:32:44 GMT -->
<head>
    <meta charset="UTF-8">
                                                        ...
                                                        <div class="droopmenu-tabsection" id="droopmenutab15">
                                                            ...
                                                            <div class="droopmenu-tabcontent">
                                                                <div class="droopmenu-row">
                                                                    <ul class="droopmenu-col droopmenu-col4">
                                                                        <li><h4>زنانه</h4></li>
                                                                        <li><a href="{{route('products')}}">حلقه ازدواج</a></li>
                                                                        <li><a href="{{route('products')}}">ساعت</a></li>
                                                                        <li><a href="{{route('products')}}">گردنبند</a></li>
                                                                        <li><a href="{{route('products')}}">ساعت</a></li>
                                                                        <li><a href="{{route('products')}}">النگو</a></li>
                                ...
                                <div class="container">
                                    <div class="row">
                                        ...
                                        <div class="col-12 col-sm-2 pt-1 text-end">
                                            <span>
                                                <a href="{{route('products.list')}}" class="products-view-type active"><i class="fa fa-th-list"></i></a>
                                                <a href="{{route('products')}}" class="products-view-type"><i class="fa fa-th"></i></a>
                                            </span>
                                            &nbsp;|&nbsp;
                                            <span>122 کالا</span>
                                        </div>
                                    ...
                                    <div class="row row-cols-1 gx-md-4">
                                        ...
                                        <div class="col">
                                            ...
                                            <div class="encode4326654321vfb-row">
                                                <div class="row">
                                                    <div class="col-12 col-md-4">
                                                        <a href="{{route('product')}}"><div class="image" style="background-image: url('assets/images/products/p100.png')"></div></a>
                                                    </div>
                                                    <div class="col-12 col-md-8">
                                                        <div class="details py-3 px-3">
                                                            <div class="category">
                                                                <a href="{{route('products')}}">گوشی موبایل</a>
                                                                &nbsp;/&nbsp;
                                                                <a href="{{route('products')}}">سامسونگ</a>
                                                            </div>
                                                            <a href="{{route('product')}}"><h2>گوشی موبایل سامسونگ مدل Galaxy A51 دو سیم کارت</h2></a>
                                                            <div class="rate">
                                        ...
                                        <div class="col">
                                            ...
                                            <div class="encode4326654321vfb-row">
                                                <div class="row">
                                                    <div class="col-12 col-md-4">
                                                        <a href="{{route('product')}}"><div class="image" style="background-image: url('assets/images/products/p101.png')"></div></a>
                                                    </div>
                                                    <div class="col-12 col-md-8">
                                                        <div class="details py-3 px-3">
                                                            <div class="category">
                                        ...
                                        <div class="col">
                                            ...
                                            <div class="encode4326654321vfb-row">
                                                <div class="row">
                                                    <div class="col-12 col-md-4">
                                                        <a href="{{route('product')}}"><div class="image" style="background-image: url('assets/images/products/p102.png')"></div></a>
                                                    </div>
                                                    <div class="col-12 col-md-8">
                                                        <div class="details py-3 px-3">
                                                            <div class="category">
                                        ...
                                        <div class="col">
                                            ...
                                            <div class="encode4326654321vfb-row">
                                                <div class="row">
                                                    <div class="col-12 col-md-4">
                                                        <a href="{{route('product')}}"><div class="image" style="background-image: url('assets/images/products/p103.png')"></div></a>
                                                    </div>
                                                    <div class="col-12 col-md-8">
                                                        <div class="details py-3 px-3">
                                                            <div class="category">
                                                ...
                                                {{route('products')}}"><h2>گوشی موبایل سامسونگ مدل Galaxy A51 دو سیم کارت</h2></a>
                                                            <div class="rate">
                                                                <i class="fa fa-star-half-alt"></i>
                                                                <i class="fa fa-star"></i>
                                                                <i class="fa fa-star"></i>
