...
<!-- Mirrored from rubik-market-html.wbrk.ir/profile/personal-info.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 12 Aug 2023 06:32:47 GMT -->
<head>
    <meta charset="UTF-8">
                ...
                <div class="col-12 col-md-4">
                    <div class="row">
                        ...
                        <div class="col-12 col-md-5 col-lg-6">
                            <a href="{{route($route)}}">
                                <div class="btn btn-warning w-100">&nbsp;<span class="d-md-none d-lg-inline-block">داشبورد</span> </div>
                            </a>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-12 px-0">
                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page"><a href="{{route('panel.admin')}}">پنل ادمینی</a></li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                                                    ...
                                                    <form action="{{route('logout')}}" method="post">
                                                        ...
                                                        <div>
                                                            <div class="icon d-inline-block">
                                                                <img src="../assets/images/icons/profile-menu/exit.webp" class="pl-2">
...
<!-- Mirrored from rubik-market-html.wbrk.ir/profile/personal-info.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 12 Aug 2023 06:32:51 GMT -->
</html>