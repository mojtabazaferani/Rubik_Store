...
<!-- Mirrored from rubik-market-html.wbrk.ir/profile/favorites.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 12 Aug 2023 06:32:51 GMT -->
<head>
    <meta charset="UTF-8">
                        ...
                        <div class="col-12 px-0">
                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="{{route('profile')}}">ناحیه کاربری</a></li>
                                ...
                                <div class="container">
                                    <div class="row row-cols-1 row-cols-sm-2 row-cols-lg-3 gx-md-4">
                                        ...
                                        <div class="col">
                                            <!-- Product Box -->
                                            <div class="encode4326654321vfb">
                                                <a href="{{route('product')}}"><div class="image" style="background-image: url('../assets/images/products/p400.png')"></div></a>
                                                <div class="details p-3">
                                                    <div class="category">
                                                        <a href="{{route('products')}}">گوشی موبایل</a>
                                                        &nbsp;/&nbsp;
                                                    ...
                                                    <a href="{{route('product')}}"><h2>دوربین دیجیتال کانن مدل EOS 2000D به همراه لنز 18-55 میلی متر DC III</h2></a>
                                                    <div class="encode4365gbf265g43d">6.000.000 تومان</div>
                                                    <div class="rate">
                                                        <i class="fa fa-star-half-alt"></i>
                                                        <i class="fa fa-star"></i>
                                        ...
                                        <div class="col">
                                            ...
                                            <div class="encode4326654321vfb">
                                                ...
                                                <div class="details p-3">
                                                    ...
                                                    <a href="{{route('product')}}"><h2>گوشی موبایل شیائومی مدل POCO X3 M2007J20CG دو سیم‌ کارت</h2></a>
