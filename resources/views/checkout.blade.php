...
<!-- Mirrored from rubik-market-html.wbrk.ir/checkout.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 12 Aug 2023 06:32:46 GMT -->
<head>
    <meta charset="UTF-8">
                                                ...
                                                <div class="col-12 col-md-9 pl-0" id="address-detail">
                                                    <div class="p-3 ml-3 mb-2 mb-md-0 ml-md-0 address-to-send">
                                                        <div class="address-title">
                                                            <span id="province-title">{{$state}}</span>،
                                                            <span id="city-title">{{$city}}</span>،
                                                            <span id="address">{{$location}}</span>،
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-12 col-md-4">کدپستی: 1234567890</div>
                                                            <div class="col-12 col-md-8">تحویل گیرنده: {{$name}} | 09351234567</div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-12 col-md-3">
                                                    <div class="row">
                                                        <div class="col-6 col-md-12 pl-2 px-md-3">
                                                            <a href="{{route('address.change')}}"><div class="btn btn-light w-100">تغییر آدرس</div></a>
                                                        </div>
                                                        <div class="col-6 col-md-12 pr-2 px-md-3">
                                                            <a href="{{route('addresses')}}"><div class="btn btn-outline-dark mt-0 mt-md-1 w-100">افزودن آدرس جدید</div></a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                    ...
                                                    <a href="{{route('product')}}" target="_blank">
                                                        <div class="encode4326654321vfb">
                                                            ...
                                                            <div class="text-center px-1 px-sm-3">
                                                                <a href="{{route('product')}}" target="_blank"><h2>گوشی موبایل سامسونگ مدل Galaxy A51 دو سیم کارت</h2></a>
                                                                <div class="number">تعداد: {{$number}} عدد</div>
                                                            </div>
                                                        </div>
                                                    </a>
                                                </span>
                                                ...
                                                <span class="col-6 col-sm-4 col-lg-3 px-0">
                                                    <a href="{{route('product')}}" target="_blank">
                                                        <div class="encode4326654321vfb">
                                                            ...
                                                            <div class="text-center px-1 px-sm-3">
                                                                <a href="{{route('product')}}" target="_blank"><h2>لپ تاپ 15 اینچی ایسوس مدل VivoBook X543MA-DM905</h2></a>
                                    ...
                                    <div class="row pb-2">
                                        ...
                                        <div class="col-12">
                                            <form action="{{route('buy')}}" method="post">
                                                @csrf
                                                <button type="submit" name="yes" value="yes" class="btn btn-success w-100">پرداخت و تکمیل خرید</button>
                                            </form>
